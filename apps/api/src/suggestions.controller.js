...
let SuggestionsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('suggestions')];
    ...
    var SuggestionsController = class {
        ...
        static {
            ...
            SuggestionsController = _classThis = _classDescriptor.value;
        ...
        async create(createSuggestionDto, res) {
            // verify the suggestion
            if (createSuggestionDto.sourceId === undefined ||
            ...
            // store to ipfs
            const storedObj = await (0, lighthouse_1.uploadText)(JSON.stringify(createSuggestionDto), process.env.LIGHTHOUSE_API_KEY);
            // TODO: send to weblate
            return res.status(common_1.HttpStatus.CREATED).json({ message: 'stored to ipfs', cid: storedObj.cid });
        }
        constructor() {
            __runInitializers(this, _instanceExtraInitializers);
        }
    };
    return SuggestionsController = _classThis;
})();
